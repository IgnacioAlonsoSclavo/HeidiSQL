...
const pool = mariadb.createPool({ host: "localhost", user: "root", password: "JAP", database: "planning", connectionLimit: 5 });
...
app.put("/todo/:id", async (req, res) => {
  ...
  try {
    ...
    const response = await conn.query(
      ...
      [req.body.name, req.body.description, req.body.status, req.body.id]
    );
